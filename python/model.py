...
# -*- coding: utf-8 -*-
"""
Created on Tue May 19 15:27:35 2026
...
class Net(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        if y is not None:
            ...
            return logits, loss, acc, self.feature, pred, y
        else:
            return logits


class CoTeachingNet(torch.nn.Module):
    def __init__(self, input_dim, hidden_size, latent_dim=[32, 32, 32], with_dropout=False):
        super(CoTeachingNet, self).__init__()
        self.network_a = Net(input_dim, hidden_size, latent_dim, with_dropout)
        self.network_b = Net(input_dim, hidden_size, latent_dim, with_dropout)

    def forward(self, data, net_id='a'):
        if net_id == 'a':
            return self.network_a(data)
        else:
            return self.network_b(data)